...
export function Hero({ time }) {
  ...
  return (
    <section className="hero" id="top" ref={heroRef}>
      ...
      <div className={`hero-headline fade-up ${heroIntersecting ? "visible" : ""}`} style={{ transitionDelay: "100ms" }}>
      ...
      <div className={`hero-bottom fade-up ${heroIntersecting ? "visible" : ""}`} style={{ transitionDelay: "300ms" }}>
        ...
        <div className="hero-cta-group mobile-only">
